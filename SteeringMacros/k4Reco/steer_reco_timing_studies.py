...
MyEcalBarrelDigi.Parameters = {
    ...
    "timingCut": ["1"],
    "timingResolution": ["0"],
    #"timingWindowMax": ["10."],  # original
    "timingWindowMax": ["1."],  # timing study: match selector (1 ns ECAL)
    "timingWindowMin": ["-0.5"],
...
MyEcalBarrelSelector.Parameters = {
    ...
    "Nsigma": ["0"],
    "TimeWindowMin": ["-0.3"],
    #"TimeWindowMax": ["0.3"],  # original
    "TimeWindowMax": ["1."],  # timing study: 1 ns ECAL
...
MyHcalBarrelSelector.Parameters = {
    ...
    "TimeWindowMin": ["-0.3"],
    #"TimeWindowMax": ["0.3"],  # original
    "TimeWindowMax": ["10."],  # timing study: 10 ns HCAL, matches digi window
    "DoBIBsubtraction": ["false"]
}
